...
export function HeroSection({
  ...
  return (
    ...
    >
      ...
      <p className={`mb-5 text-[var(--ink-soft)] ${isArabic ? 'font-ar-body text-lg leading-8' : 'text-base leading-7'}`}>
        {copy.heroSubline}
      </p>
      <div className="rounded-3xl border border-[rgba(255,190,85,0.25)] bg-[rgba(255,255,255,0.05)] px-4 py-4 sm:px-5">
        <motion.p
          initial={{ opacity: 0, textShadow: '0 0 0 rgba(255,78,159,0)' }}
          animate={{
            opacity: 1,
            textShadow: [
              '0 0 12px rgba(255,78,159,0.4)',
              '0 0 18px rgba(255,78,159,0.6)',
              '0 0 12px rgba(255,78,159,0.4)',
            ],
          }}
          transition={{
        ...
        <motion.p
          ...
          className={`text-center text-[var(--ink-soft)] ${isArabic ? 'font-ar-body text-lg leading-8' : 'text-base leading-7'}`}
        >
          {introLine}
        </motion.p>
      </div>
